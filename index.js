...
function getArtistByIndex(a, n){
  return `the artist at index ${a[n].id} is ${a[n].name}`
}
...
function get20s(array){
  ...
  let birthYear = array[i].years.split(" - ")[0]
  let deathYear = array[i].years.split(" - ")[1]
